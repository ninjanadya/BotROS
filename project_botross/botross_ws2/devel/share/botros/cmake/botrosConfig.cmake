...
if("TRUE" STREQUAL "TRUE")
  set(botros_SOURCE_PREFIX /media/s4mothy/HI THERE/programming/school/csci5551/project_botross/botross_ws2/src/botros)
  set(botros_DEVEL_PREFIX /media/s4mothy/HI THERE/programming/school/csci5551/project_botross/botross_ws2/devel)
  set(botros_INSTALL_PREFIX "")
  set(botros_PREFIX ${botros_DEVEL_PREFIX})
else()
  set(botros_SOURCE_PREFIX "")
  set(botros_DEVEL_PREFIX "")
  set(botros_INSTALL_PREFIX /media/s4mothy/HI THERE/programming/school/csci5551/project_botross/botross_ws2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'botros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/s4mothy/HI THERE/programming/school/csci5551/project_botross/botross_ws2/src/botros/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(botros_EXPORTED_TARGETS ${${botros_dep}_EXPORTED_TARGETS})
endforeach()
